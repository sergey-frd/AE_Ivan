var location = "e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Ivan\\log\\";
var scr_name = "AE_Ivan_22_3";
...
#include "sf_scr_lib_Ivan__1.jsx"
...
function main() 
{
   ...
   // AAAAAAAAAAAAAAAAAAAAAAAAAAAA
    //genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Ivan\\xml\\gen_Ivan_22a_1.xml");
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Ivan\\xml\\gen_Ivan_22a_2.xml");
    ...
    // 
    // genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Ivan\\xml\\gen_Ivan_22b_2.xml");
    // lg.writeln(" genXml: " + genXml.toString());
    // var logName       = genXml.logName;
    // var pathRrXml     = genXml.pathRrXml;
    // lg.writeln(" pathRrXml: " + pathRrXml.toString());
    ...
    var compFinalName = "aeFinalAE_IvanAll_1";
    ...
    // 
    // var compFinalName = "aeFinalAE_Ivan_1";
    // finalComp = handleFinalComp4(compFinalName);
    // 
    // var compFinalName = "aeFinalAE_IvanBaseBg_1";
    // finalComp = handleFinalCompBaseBg(compFinalName);
    // 
    // var compFinalName = "aeFinalAE_IvanBg_1";
    // finalComp = handleFinalCompBg(compFinalName);
    // 
    // 
    // var compFinalName = "aeFinalAE_IvanBase_1";
    // finalComp = handleFinalCompBase(compFinalName);
    // 
    // 
    // var compFinalName = "aeFinalAE_IvanBaseBi_1";
